...
type PublishedVolumeInterface interface {
	...
	UpdateStatus(*v1beta1.PublishedVolume) (*v1beta1.PublishedVolume, error)
...
func (c *publishedVolumes) UpdateStatus(publishedVolume *v1beta1.PublishedVolume) (result *v1beta1.PublishedVolume, err error) {
	result = &v1beta1.PublishedVolume{}
	err = c.client.Put().
		Resource("publishedvolumes").
		Name(publishedVolume.Name).
